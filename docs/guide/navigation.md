...
By pressing <kbd>o</kbd> or click the <carbon-user-speaker class="inline-icon-btn"/> button in the navigation bar, you can have the overview of your slides so you can jump between them easily. 
